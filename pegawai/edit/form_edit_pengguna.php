...
$id = intval($_GET['id']);
            ...
            <form action="./edit_pengguna.php?id=<?php echo $row[0]?>" method="post">
                <div class="form-item">
                    <label for="var_name">Nama</label>
                    <input type="text" name="var_name" value = "<?php echo $row[1] ?> "class="form-input" required>
                </div>
                <div class="form-item">
                    <label for="var_name">Password</label>
                    <input type="password" name="password" value = "<?php echo $row[2] ?> "class="form-input" required>
                </div>
                <div class="form-item">
