...
$id = intval($_GET['id']);
            ...
            <form action="./edit_tindakan.php?id=<?php echo $row[0]?>" method="post">
                <div class="form-item">
                    <label for="var_name">Keterangan</label>
                    <input type="text" name="var_name" value = "<?php echo $row[1] ?> "class="form-input" required>
                </div>
                <div class="form-item">
                    <label for="var_name">Harga</label>
                    <input type="text" name="harga" value = "<?php echo $row[2] ?> "class="form-input" required>
                </div>
                <div class="form-item">
