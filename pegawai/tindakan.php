...
<body>
    ...
    <div class="container_body">
        ...
        <a href="./tambah/form_tambah_tindakan.php">
        ...
        <span>Add Data</span>
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                  ...
                  echo '<td>';
                    echo '<a href="./hapus/hapus_tindakan.php/?id='.$row["id_tindakan"].'">';
                        echo '<button class="btn btn-abang">';
                            echo '<i class="fas fa-trash"></i>';
                        echo '</button>';
                    echo '</a>';
                                  
                    echo '<a href="./edit/form_edit_tindakan.php?id='.$row["id_tindakan"].'">';
